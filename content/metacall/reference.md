...
- [Deem](/deem/introduction/) and [Trama](/trama/introduction/) — the DSLs riding the 3-arg `#[token_macro]` handler seam; [Introduction](/docs/introduction/) for where metaprogramming sits in the language.
